```
CHX Cosolvent MD Simulations

This directory contains the input files and analysis results for PRMT1 with CHX as a cosolvent probe.

Files
SAM_chx.cut10.wat.prmtop: Topology file (AMBER format)

SAM_chx.cut10.wat.inpcrd: Initial coordinates

SAM_chx.equil.norests.rst: Equilibrated structure
