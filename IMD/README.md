```
IMD Cosolvent MD Simulations

This directory contains the input files and analysis results for PRMT1 with IMD as a cosolvent probe.

Files
SAM_IMD.cut10.wat.prmtop: Topology file (AMBER format)

SAM_IMD.cut10.wat.inpcr: Initial coordinates

SAM_IMD.equil.norests.rst: Equilibrated structure
